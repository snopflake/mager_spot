        ...
        body: BlocConsumer<AuthCubit, AuthState>(
          ...
          if (state is AuthSuccess) {
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(builder: (_) => const ConfirmPenjual())
                );
        ...
        children: [
          ...
          Buttons(
              ...
              onClicked: () {
                context
                    .read<AuthCubit>()
                    .register(namaController.text, emailController.text, passwordController.text);
              },
              width: mediaSize.width),
